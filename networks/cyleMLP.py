...
def cyleMLP_basic_blocks(dim, index, layers, mlp_ratio=3., qkv_bias=False, qk_scale=None, attn_drop=0.,
...
class CycleNet(nn.Module):
    ...
    def __init__(self, layers, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        for i in range(len(layers)):
            stage = cyleMLP_basic_blocks(embed_dims[i], i, layers, mlp_ratio=mlp_ratios[i], qkv_bias=qkv_bias,
